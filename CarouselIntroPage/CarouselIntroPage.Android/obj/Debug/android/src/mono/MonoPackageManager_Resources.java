...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "CarouselIntroPage.Android.dll" comes first in this list. */
		"CarouselIntroPage.Android.dll",
		"CarouselIntroPage.dll",
		"FormsViewGroup.dll",
